...
'''
#A função poderá ser chamada a quantiade de vezes que for nescessário, independente da quantidade de perguntas que vamos responder no telegram
...
#Syntaxe de execução da função: salvar_dataframe_csv("o nome da darivel que esta o dataframe", "nome da planilha.csv")
